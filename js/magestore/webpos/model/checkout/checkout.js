...
define(
    ...
    function ($, ko, __, CartModel, DiscountModel, HelperPrice, OrderHelper, Staff, DateTime, Event, Totals, Helper, Alert, OrderFactory, CheckoutResource, CreditCard, DataManager, AddNoti, Tills, DirectPost) {
        "use strict";
        ...
        var CheckoutModel = {
            ...
            getOrderParams: function(){
                ...
                var orderParams = {
                    ...
                    extension_data:[
                        ...
                        {
                            key:"webpos_till_id",
                            value: Tills.currentTill().id,
                        },
                        {
                            key:"created_at",
                            value: DateTime.getSqlDatetime(),
                        }
                    ],
                    session_data:[
                    ],
            ...
            getOfflineOrderData: function(){
                var self = this;
                var createdTime = DateTime.getBaseSqlDatetimeFormated();
