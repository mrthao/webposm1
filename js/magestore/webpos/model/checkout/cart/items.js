            ...
            getAddedItem: function(data){
                ...
                if(typeof data.item_id != "undefined"){
                    ...
                    if(typeof data.hasOption !== "undefined"){
                        var foundItem = ko.utils.arrayFirst(this.items(), function(item) {
                            return (
                                (data.hasOption === false && item[ItemInterface.PRODUCT_ID]() == data.product_id) ||
                                (data.hasOption === true && item[ItemInterface.PRODUCT_ID]() == data.product_id && item[ItemInterface.OPTIONS_LABEL]() == data.options_label )
                            );
                        });
                        if(foundItem){
                            return foundItem;
