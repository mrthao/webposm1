    ...
    function ($,ko, modelAbstract, restResource, indexedDbResource, collection, StockItemFactory) {
        ...
        return modelAbstract.extend({
            ...
            getInfoBuyRequest: function(customer_group){
                ...
                if(typeof product.unit_price != "undefined" && ((product.type_id == 'simple' && product.options == 1)
                    || product.type_id == 'configurable' || product.type_id == 'grouped'
                    || product.type_id == 'virtual' || product.type_id == 'bundle' || product.type_id =='customercredit') ){
